...
def get_traning_data(theta, num_simulations):
    "varying only five parameters: F_STAR10, F_ESC10, ALPHA_STAR, t_STAR, NU_X_THRESH"
...
np.save('data/ps_training_data_f_star10_f_esc10_alpha_star_t_star_nu_x_thresh_ska_1080_num_simulations_30000.npy', x)
np.save('data/theta_training_data_f_star10_f_esc10_alpha_star_t_star_nu_x_thresh_ska_1080_num_simulations_30000.npy', theta.cpu().numpy())