...
def get_traning_data(theta, num_simulations):
    " varying five parameters: F_STAR10, F_ESC10, ALPHA_STAR, t_STAR, NU_X_THRESH"
...
names = ['F_STAR10', 'F_ESC10', 'ALPHA_STAR', 't_STAR', 'NU_X_THRESH']
